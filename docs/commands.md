...
All commands contributed by Out-of-Code Insights, grouped by purpose.
Run any command from the Command Palette (`Ctrl+Shift+P`) or bind a custom
keyboard shortcut via **File > Preferences > Keyboard Shortcuts**.
...
| `annotations.batchCreateMixed`         | Batch Create Mixed Items       | --                 |
